...
<br />
<br />
Docker Snippets is an a collection of Adhoc commands and YAML scripts.

I wanted to experiment with Docker and trying the multiple options that it could offer.
...
1. building_swarm.md is a set of commands I built to create docker swarm
